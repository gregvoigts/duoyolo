...
from duoYolo.models.yolo import classify, multitask
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            multitask.MultitaskValidator,
            multitask.MultitaskPredictor,
            {"task_0": "coco8.yaml", "task_1": "coco8-seg.yaml"},
            "duoyolo11n-od-seg.yaml",
            None,
        ),
        (
            yolo.DetectionTrainer,
...
def test_resume_incomplete(task, weight, data, tmp_path):
    ...
    resume_model = DuoYOLO(last_path)
